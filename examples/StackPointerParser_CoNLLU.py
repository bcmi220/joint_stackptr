    ...
    if not is_predict:
        ...
        for epoch in range(1, num_epochs + 1):
            ...
            for batch in conllu_stacked_data.iterate_batch_stacked_variable(data_dev, batch_size):
                ...
                heads_pred, types_pred, _, _ = network.decode(word, char, pos, mask=masks, length=lengths, beam=beam, leading_symbolic=conllu_stacked_data.NUM_SYMBOLIC_TAGS)
        ...
        for batch in conllu_stacked_data.iterate_batch_stacked_variable(data_eval, batch_size):
            ...
            eval_writer.write(word, pos, heads_pred, types_pred, lengths, symbolic_root=True)
